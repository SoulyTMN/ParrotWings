...
namespace ParrotWIngs.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<IHttpActionResult> Register(RegisterBindingModel model)
        {
            ...
            var user = new ApplicationUser() { PwName = model.PwName, UserName = model.Email, Email = model.Email };
        ...
        private static class RandomOAuthStateGenerator
        {
            ...
            public static string Generate(int strengthInBits)
            {
                ...
                {
                    throw new ArgumentException("Value for strengthInBits must  be aliquot to 8.", "strengthInBits");
                }
